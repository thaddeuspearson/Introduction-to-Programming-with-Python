...
happened all the keys and values were stored in a new memory locaation,
...
in dict1 and dict2. In this case a deepcopy chould have been done to ensure
this kind of likely unwanted behavior would have been avoided.
"""
